...
public class PanelPantallaJuego  extends JPanel{
	...
	public Observer incorporarSilueta(EntidadLogica entidad_logica) {
		...
		imagenFondoPanelMapa.setPreferredSize(new Dimension(imagenFondoPanelMapa.getIcon().getIconWidth(), imagenFondoPanelMapa.getIcon().getIconHeight()));
		return observerEntidad;
	}
	...
	protected void actualizarLabelsInformacion(EntidadLogicaJugador entidadJugador) {
		...
		labelPuntaje.setText("Puntaje: " + String.valueOf(entidadJugador.getPuntaje()) + " Vidas: " + String.valueOf(entidadJugador.getVidas()));
	}
	...
	protected void agregarPanelMapaConFondoYScroll() {
		...
		panelMapa.setPreferredSize(new Dimension(ConstantesVentana.PANEL_MAPA_ANCHO, ConstantesVentana.PANEL_MAPA_ALTO));
	...
	protected void agregarPanelInformacion() {
		...
		panelInformacion.setPreferredSize(new Dimension(ConstantesVentana.PANEL_INFORMACION_ANCHO, ConstantesVentana.PANEL_INFORMACION_ALTO));
	...
	protected void agregarImagenFondoPanelInformacion() {
		...
		Image imagenEscalada = iconoImagen.getImage().getScaledInstance(ConstantesVentana.PANEL_INFORMACION_ANCHO, ConstantesVentana.PANEL_INFORMACION_ALTO, Image.SCALE_SMOOTH);
		Icon iconoImagenEscalada = new ImageIcon(imagenEscalada);
		imagenFondoPanelInformacion.setIcon(iconoImagenEscalada);
		imagenFondoPanelInformacion.setBounds(0,0, ConstantesVentana.PANEL_INFORMACION_ANCHO, ConstantesVentana.PANEL_INFORMACION_ALTO);
	}
